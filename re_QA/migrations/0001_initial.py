    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='re_QA.answeruser')),
            ],
        ),
        migrations.CreateModel(
            name='ValidationCode',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.IntegerField(default=0)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='re_QA.answeruser', verbose_name='ユーザー')),
            ],
        ),
    ]
